...
//        dump($timeSql10);
        ...
        $this->finder->find('', 100);
        $endElastic100 = microtime();
        $startMysql100 = microtime();
        $bookRepository->findByLimit(100);
...
//        dump($timeSql100);
        ...
        $this->finder->find('', 1000);
        $endElastic1000 = microtime();
        $startMysql1000 = microtime();
        $bookRepository->findByLimit(1000);
...
//        dump($timeSql1000);
        ...
        $this->finder->find('', 10000);
        $endElastic10000 = microtime();
        $startMysql10000 = microtime();
        $bookRepository->findByLimit(10000);
